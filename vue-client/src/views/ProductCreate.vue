<template>
  <main class="mt-3">
    <div class="container">
      ...
      <div class="mb-3 row">
        <label class="col-md-3 col-form-label">SKU코드</label>
        <div class="col-md-9">
          <div class="input-group mb-3">
            <input type="text" class="form-control" v-model="product.sku_code">
          </div>
        </div>
      </div>      
      <div class="mb-3 row">
    ...
    productInsert() {
      ...
      this.$swal.fire({
        ...
        if (result.isConfirmed) { 
          ...
          await this.axios.post("/products",JSON.stringify(this.product));
